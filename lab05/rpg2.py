...
if __name__ == "__main__":
    ...
    master_sword = Weapon(name='Master Sword', rarity='legendary', damage=345, type='sword')
    broken_pot_lid = Shield(name='Wooden Lid', description='A lid made of wood, useful in cooking.', defense=5,
                            broken=True)
    muramasa = Weapon(name='Muramasa', rarity='legendary', damage=400, type='katana')
    gungnir = Weapon(name='Gungnir', rarity='legendary', damage=450, type='spear')
